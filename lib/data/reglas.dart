...
class Regla {
  final String rol;
  final String
  momento; // "primera_noche", "cada_noche", "al_morir", "al_votar", "al_dia"
...
const List<Regla> reglas = [
  ...
  // Asignación de lobos comunes al final de la primera noche
  Regla(
    rol: 'Hombres Lobo Comunes',
    momento: 'primera_noche',
    orden: 98, // al final: se asignan los N lobos
    frecuencia: 'una_vez',
    condicion: 'El narrador asigna a los jugadores que serán lobos comunes',
  ),

  // --- Cada noche: prioridad Vidente antes que Lobos ---
  Regla(
    rol: 'Vidente',
    momento: 'cada_noche',
    orden: 10, // prioridad antes que lobos
    frecuencia: 'repetido',
    condicion: 'Puede ver la carta de un jugador',
  ),
  Regla(
  ...
  Regla(
    rol: 'Hombres Lobo Comunes',
    momento: 'cada_noche',
    orden: 12, // después de la Vidente
    frecuencia: 'repetido',
  ...
  Regla(
    rol: 'Caballero de la Espada Oxidada',
    momento: 'al_morir',
    orden: 32,
    frecuencia: 'una_vez',
